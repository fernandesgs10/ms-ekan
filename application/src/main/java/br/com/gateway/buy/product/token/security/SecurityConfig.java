package br.com.gateway.buy.product.token.security;

import br.com.gateway.buy.product.token.filter.JwtAuthenticationFilter;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        return http
                ...
                .authorizeHttpRequests(auth -> auth
                        .requestMatchers(
                                AntPathRequestMatcher.antMatcher("/v1/muvz-tech/auth/login"),
                ...
                .csrf(csrf -> csrf
                        .ignoringRequestMatchers(AntPathRequestMatcher.antMatcher("/v1/muvz-tech/auth/login"))
